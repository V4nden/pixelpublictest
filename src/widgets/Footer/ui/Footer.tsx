      ...
      <div className="m-auto sm:w-[95%] md:w-[75%] lg:w-[65%] max-w-[1600px] flex sm:flex-col md:flex-row justify-between">
        ...
        <div className="flex items-center gap-4 text-xl text-[#fff]">
          <Link
            ...
            className="bg-[#24A1DE] rounded-xl p-2 transition-all hover:scale-105 ease-out"
          >
            <FaTelegramPlane />
          </Link>
          <Link
            href={"https://discord.gg/mdUqm9dKbE"}
            className="bg-[#7289da] rounded-xl p-2 transition-all hover:scale-105 ease-out"
          >
            <FaDiscord />
          </Link>
          <Link
            href={"https://www.youtube.com/channel/UCDxpxE7YG5dz1e2VZoekDow"}
            className="bg-[#f00] rounded-xl p-2 transition-all hover:scale-105 ease-out"
          >
            <FaYoutube />
          </Link>
          <Link
            href={"https://vk.com/pixelvanilla"}
            className="bg-[#0077FF] rounded-xl p-2 transition-all hover:scale-105 ease-out"
          >
            <FaVk />
          </Link>
        </div>
